...
public class RocksDBWriterFactory {
	...
	/**
	 * Provides a factory for {@link RocksDBWriter}, including {@link RocksDBWriteBatchWrapper}
	 * and {@link RocksDBSSTIngestWriter}. The factory also provides a "default" writer, determined by
	 ...
	 *
	 * <p>This is only used in tests, where the tests pull some default configuration values but provide the mechanism being tested. Tests should parameterize {@link WriteBatchMechanism}.
	 */
	@VisibleForTesting
	 ...
	 * configuration, a {@link RocksDBWriteBatchWrapper} or {@link RocksDBSSTIngestWriter} may be used.
	 *
	...
	/**
	 * Returns a new {@link RocksDBWriteBatchWrapper}, using the user-configured parameters. The type
	 * {@link RocksDBWriteBatchWrapper} is exposed directly because it provides additional {@link
	 ...
	 */
	public RocksDBSSTIngestWriter sstIngestWriter(
		@Nonnull RocksDB db, @Nullable Options options, @Nullable EnvOptions envOptions, @Nonnull File tempDir)
		throws IOException {
		// @lgo: plumb through parameters.
		final int maxSstSize = 10;
