...
/**
 * {@link RocksDBWriteBatchWrapper} is a wrapper class around RocksDB's {@link WriteBatch} for writing in bulk.
 *
 * <p>IMPORTANT: This class is not thread safe.
 *
 * <p>Use {@link RocksDBWriteBatchWrapper} for general purpose writes to RocksDB. It is ideal for synchronous path writes where a few writes ae being done. When doing batch writes of ordered data, prefer {@link RocksDBSSTIngestWriter}.
 */
